...
static void test_bppp_generators_fixed(void) {
    ...
    const unsigned char fixed_first_11[330] = {
        ...
        ,
    };
    size_t len;
...
void norm_arg_zero(void) {
    ...
    /* l is zero vector and n is zero vectors of length 1 each. */
    {
        ...
        unsigned int c_vec_len = 1;
         /* Manually create generators to bypass the secp256k1_bppp_generators_create
            function which has minimum length requirement of 8. */
        secp256k1_ge inner_gens[2];
        secp256k1_bppp_generators gens;
        gens.gens = &inner_gens[0];
        gens.n = 2;
        random_group_element_test(&gens.gens[0]);
        random_group_element_test(&gens.gens[1]);
        ...
        CHECK(secp256k1_bppp_commit(ctx, scratch, &commit, &gens, &asset_genp, n_vec, n_vec_len, l_vec, c_vec_len, c_vec, c_vec_len, &q));
        {
            secp256k1_scalar *ns, *ls, *cs;
            secp256k1_ge *gs;
            ...
            CHECK(secp256k1_bppp_rangeproof_norm_product_prove(ctx, scratch, proof, &plen, &transcript, &r, gs, gens.n, &asset_genp, ns, n_vec_len, ls, c_vec_len, cs, c_vec_len));
            secp256k1_scratch_apply_checkpoint(&ctx->error_callback, scratch, scratch_checkpoint);
        }
        secp256k1_sha256_initialize(&transcript);
        CHECK(secp256k1_bppp_rangeproof_norm_product_verify(ctx, scratch, proof, plen, &transcript, &r, &gens, &asset_genp, c_vec_len, c_vec, c_vec_len, &commit));
    }
     ...
     * internal commitments X or R to be the point at infinity. */
    {
        ...
        CHECK(secp256k1_bppp_commit(ctx, scratch, &commit, gs, &asset_genp, n_vec, n_vec_len, l_vec, c_vec_len, c_vec, c_vec_len, &q));
        CHECK(!secp256k1_norm_arg_prove(scratch, proof, &plen, &r, gs, &asset_genp, n_vec, n_vec_len, l_vec, c_vec_len, c_vec, c_vec_len, &commit));
    ...
    /* Verify vectors of length 0 */
    {
        ...
        gs.gens = &inner_gens[0];
        gs.n = 2;
        random_group_element_test(&gs.gens[0]);
        random_group_element_test(&gs.gens[1]);
        ...
        CHECK(secp256k1_bppp_commit(ctx, scratch, &commit, &gs, &asset_genp, n_vec, n_vec_len, l_vec, c_vec_len, c_vec, c_vec_len, &q));
        CHECK(secp256k1_norm_arg_prove(scratch, proof, &plen, &r, &gs, &asset_genp, n_vec, n_vec_len, l_vec, c_vec_len, c_vec, c_vec_len, &commit));
        CHECK(secp256k1_norm_arg_verify(scratch, proof, plen, &r, &gs, &asset_genp, n_vec_len, c_vec, c_vec_len, &commit));
        CHECK(!secp256k1_norm_arg_verify(scratch, proof, plen, &r, &gs, &asset_genp, 0, c_vec, c_vec_len, &commit));
        CHECK(!secp256k1_norm_arg_verify(scratch, proof, plen, &r, &gs, &asset_genp, n_vec_len, c_vec, 0, &commit));
    }
...
void norm_arg_test(unsigned int n, unsigned int m) {
    ...
    res = secp256k1_bppp_commit(ctx, scratch, &commit, gs, &asset_genp, n_vec, n, l_vec, m, c_vec, m, &q);
    CHECK(res == 1);
    res = secp256k1_norm_arg_prove(scratch, proof, &plen, &r, gs, &asset_genp, n_vec, n, l_vec, m, c_vec, m, &commit);
    CHECK(res == 1);

    res = secp256k1_norm_arg_verify(scratch, proof, plen, &r, gs, &asset_genp, n, c_vec, m, &commit);
    CHECK(res == 1);
...
int norm_arg_verify_vectors_helper(secp256k1_scratch *scratch, const unsigned char *gens, const unsigned char *proof, size_t plen, const unsigned char *r32, size_t n_vec_len, const unsigned char c_vec32[][32], secp256k1_scalar *c_vec, size_t c_vec_len, const unsigned char *commit33) {
    ...
    ret = secp256k1_bppp_rangeproof_norm_product_verify(ctx, scratch, proof, plen, &transcript, &r, gs, &g_asset_gen, n_vec_len, c_vec, c_vec_len, &commit);
